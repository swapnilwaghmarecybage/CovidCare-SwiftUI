...
struct ChildCountTableViewCell: View {
    init(regionDetails: Any?) {
        if let countryObject = regionDetails as? CountryViewModel {
        ...
        } else if let stateObject = regionDetails as? StateViewModel {
        ...
        } else if let districtObject = regionDetails as? DistrictViewModel {
            isFlagAvaibalbe = false
            ...
            VStack {
                ...
                HStack {
                    VStack {
                        Text("Confirmed").foregroundColor( Color( Theme.labelColor ) )
                            .frame(height: ((1 - heightScaleFactorForTitle) * heightOfContainer) * 0.50,
                                   alignment: .center)
                            .font(.system(size: 17))
                        Text("\(confirmed)").foregroundColor(Color(CaseType.confirmed.color))
                        .frame(height: ((1 - heightScaleFactorForTitle) * heightOfContainer) * 0.50,
                               alignment: .center)
                        .font(.system(size: 17))
                    ...
                    VStack {
                        ...
                        Text("\( recovered )").foregroundColor(Color(CaseType.recovered.color))
                        .frame(height: ((1 - heightScaleFactorForTitle) * heightOfContainer) * 0.50,
                               alignment: .center)
                        .font(.system(size: 17))
                    ...
                    VStack {
                        ...
                        Text("\( deceased )").foregroundColor(Color(CaseType.deceased.color))
                        .frame(height: ((1 - heightScaleFactorForTitle) * heightOfContainer) * 0.50,
                               alignment: .center)
                        .font(.system(size: 17))
