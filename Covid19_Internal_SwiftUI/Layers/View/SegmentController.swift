...
struct SegmentController: View {
    ...
    init(index: Binding<Int>) {
        ...
        UISegmentedControl.appearance().setTitleTextAttributes([.foregroundColor: Theme.selectedSegmentControlColor],
                                                               for: .selected)
        UISegmentedControl.appearance().setTitleTextAttributes([.foregroundColor: Theme.unSelectedSegmentControlColor],
                                                               for: .normal)
